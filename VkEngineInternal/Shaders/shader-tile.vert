...
void HandleInstance(in InstanceData instance)
{
    ...
    gl_Position = CalculatePosition(instance.position, instance.shape, pushConstants.cameraPosition, inPosition, pushConstants.resolution, pushConstants.pixelSize * pushConstants.entitySize);
}
