...
namespace game
{
	...
	public:
		...
		[[nodiscard]] static MeshBuffer CreateBuffer(const EngineOutData& outData, jlb::ArrayView<Type> data, VkBufferUsageFlags usageFlags);
	...
	template <typename Type>
	MeshBuffer MeshHandler::CreateBuffer(const EngineOutData& outData, const jlb::ArrayView<Type> data, const VkBufferUsageFlags usageFlags)
	{
